            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="abt-img img-full">
                        <img src="{{asset('frontEndAssets')}}/images/bg/about.jpg" alt="jobhere">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single-team">
                        <div class="team-img">
                            <img src="{{asset('frontEndAssets')}}/images/team/1.jpg" alt="jobhere">
                        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single-team">
                        <div class="team-img">
                            <img src="{{asset('frontEndAssets')}}/images/team/2.jpg" alt="jobhere">
                        </div>
                        <div class="team-content">
                            <h5>Jon Dowe</h5>
                            <h6>CEO Jobhere</h6>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single-team">
                        <div class="team-img">
                            <img src="{{asset('frontEndAssets')}}/images/team/3.jpg" alt="jobhere">
                        </div>
                        <div class="team-content">
                            <h5>Jon Dowe</h5>
                            <h6>CEO Jobhere</h6>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single-team">
                        <div class="team-img">
                            <img src="{{asset('frontEndAssets')}}/images/team/4.jpg" alt="jobhere">
                        </div>
                        <div class="team-content">
                            <h5>Jon Dowe</h5>
                            <h6>CEO Jobhere</h6>
