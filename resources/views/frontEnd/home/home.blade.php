    ...
    <div class="slider-area">
        <div class="preview-2">
            ...
            <div id="nivoslider" class="slides">
                ...
                <img src="{{asset($slider->sImage)}}" alt="slider_image" title="#slider-1-caption{{$i++}}"/>
                @endforeach
            </div>
            @php $i=1
            @endphp
                            ...
                            <div class="col-md-12">
                                <div class="text-content-wrapper">
                                    <div class="text-content text-center">
                                        ...
                                        <h1 class="title1 wow bounceInRight text-white mb-16" data-wow-duration="3s" data-wow-delay="0s">
                                            {{$slider->title}}
                                        </h1>
                                        <p class="sub-title wow bounceInRight hidden-xs" data-wow-duration="3s" data-wow-delay="1s">
                                            {{substr($slider->contenti,0,80)}}<br>
                                            {{substr($slider->contenti,81,160)}}<br>
                                            {{substr($slider->contenti,161,220)}}
                                        </p>
                                        <div class="banner-readmore wow bounceInUp mt-35" data-wow-duration="3s" data-wow-delay="2s">
                                            <a class="button slider-btn" href="{{route('about')}}">ABOUT US</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="category-item2">
                        <div class="img-icon">
                            <img src="{{asset('frontEndAssets')}}/images/icons/cate.png" alt="">
                        </div>
                        <div class="cat-text">
